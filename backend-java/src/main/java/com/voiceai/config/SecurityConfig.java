...
import com.voiceai.auth.AdminAuthorization;
import com.voiceai.auth.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtAuthFilter jwtAuthFilter, AdminAuthorization adminAuthorization) {
